      ...
      <div className="flex items-center justify-between text-sm text-gray-500">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-1" title="Answers">
            ...
            <span aria-label={`${item.answersCount}${tr.answers}`}>{item.answersCount}</span>
          </div>
          ...
          <div className="flex items-center gap-1" title="Views">
            ...
            <span aria-label={`${item.views}${tr.views}`}>{item.views}</span>
          </div>
          ...
          <div className="flex items-center gap-1" title="Votes">
            ...
            <span aria-label={`${item.votes}${tr.votes}`}>{item.votes}</span>
          </div>
        </div>
